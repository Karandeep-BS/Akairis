...
export default function Bubbles4() {
  // 👇 Change this color to update all icons
  const iconColor = "gray"

  const bubbles = [
    { height: "15vh", width: "15vh", bottom: "10vh", left: "5vh", duration: "3.2s", icon: Server },
    { height: "15vh", width: "15vh", bottom: "3vh", left: "40vh", duration: "3.4s", icon: ShieldCheck },
    { height: "15vh", width: "15vh", bottom: "30vh", left: "50vh", duration: "2.3s", icon: Database },
    { height: "15vh", width: "15vh", bottom: "11vh", left: "70vh", duration: "3.2s", icon: Network },
    { height: "15vh", width: "15vh", bottom: "26vh", left: "90vh", duration: "2.7s", icon: Cloud },
    { height: "15vh", width: "15vh", bottom: "30vh", left: "110vh", duration: "5.5s", icon: Settings2 },
    { height: "15vh", width: "15vh", bottom: "50vh", left: "130vh", duration: "4.1s", icon: Monitor },
    { height: "15vh", width: "15vh", bottom: "34vh", left: "170vh", duration: "2.5s", icon: FileCog },
    { height: "15vh", width: "15vh", bottom: "3vh", left: "130vh", duration: "4.2s", icon: FolderOpen },
    { height: "25vh", width: "25vh", bottom: "3vh", left: "100vh", duration: "3.8s", icon: LifeBuoy },
